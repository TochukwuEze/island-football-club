                ...
                <ul className="flex flex-col py-1">
                  {eventsDropdownItems.map((subItem) => (
                    <li key={subItem.label}>
                      <Link
                        href={subItem.href}
                        className="group/item flex items-center justify-between px-6 py-3 text-zinc-700 hover:text-primaryColor hover:bg-zinc-50 transition-all text-base font-semibold border-l-0 hover:border-l-4 border-primaryColor"
                      >
